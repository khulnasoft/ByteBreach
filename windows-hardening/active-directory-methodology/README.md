...
* [**OSINT**](khulnasoft.github.io/bytebreach/external-recon-methodology):
...
[**Read this page about different ways to obtain the hashes.**](https://github.com/khulnasoft/bytebreach/blob/master/windows-hardening/active-directory-methodology/broken-reference/README.md)
...
[**More information about how to steal the NTDS.dit can be found here**](https://github.com/khulnasoft/bytebreach/blob/master/windows-hardening/active-directory-methodology/broken-reference/README.md)
...
{% embed url="https://cloud.bytebreach.xyz/pentesting-cloud/azure-security/az-lateral-movements/azure-ad-connect-hybrid-identity" %}
