...
int main(int argc, const char *argv[]) {
    xpc_connection_t service = xpc_connection_create_mach_service("xyz.bytebreach.service",
...
int main(int argc, const char *argv[]) {
    xpc_connection_t connection = xpc_connection_create_mach_service("xyz.bytebreach.service", NULL, XPC_CONNECTION_MACH_SERVICE_PRIVILEGED);
...
{% tab title="xyz.bytebreach.service.plist" %}
```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"> <plist version="1.0">
<dict>
<key>Label</key>
<string>xyz.bytebreach.service</string>
<key>MachServices</key>
    <dict>
        <key>xyz.bytebreach.service</key>
        <true/>
    </dict>
<key>Program</key>
...
# Load daemon
sudo cp xyz.bytebreach.service.plist /Library/LaunchDaemons
sudo launchctl load /Library/LaunchDaemons/xyz.bytebreach.service.plist

# Call client
./xpc_client

# Clean
sudo launchctl unload /Library/LaunchDaemons/xyz.bytebreach.service.plist
sudo rm /Library/LaunchDaemons/xyz.bytebreach.service.plist /tmp/xpc_server
```
...
int main(void) {
    ...
    NSXPCListener *listener = [[NSXPCListener alloc] initWithMachServiceName:@"xyz.bytebreach.svcoc"];
...
int main(void) {
    NSXPCConnection *connection = [[NSXPCConnection alloc] initWithMachServiceName:@"xyz.bytebreach.svcoc" options:NSXPCConnectionPrivileged];
...
{% tab title="xyz.bytebreach.svcoc.plist" %}
```xml
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"> <plist version="1.0">
<dict>
<key>Label</key>
<string>xyz.bytebreach.svcoc</string>
<key>MachServices</key>
    <dict>
        <key>xyz.bytebreach.svcoc</key>
        <true/>
    </dict>
<key>Program</key>
...
# Load daemon
sudo cp xyz.bytebreach.svcoc.plist /Library/LaunchDaemons
sudo launchctl load /Library/LaunchDaemons/xyz.bytebreach.svcoc.plist

# Call client
./oc_xpc_client

# Clean
sudo launchctl unload /Library/LaunchDaemons/xyz.bytebreach.svcoc.plist
sudo rm /Library/LaunchDaemons/xyz.bytebreach.svcoc.plist /tmp/oc_xpc_server
```
...
{
        NSString*  _serviceName = @"xyz.bytebreach.svcoc";
